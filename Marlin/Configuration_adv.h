...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  70, 35 }, { 230,  35 }, { 230, 200 }, { 70, 200 } }
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  35.72          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  35.72          // (Hz) The default dominant resonant frequency on the Y axis.
...
//
//#define LCD_BACKLIGHT_TIMEOUT_MINS 30  // (minutes) Timeout before turning off the backlight
